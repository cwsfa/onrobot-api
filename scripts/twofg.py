...
class TWOFG():
    ...
    def get_min_int_width(self, t_index=0):
        '''
    ...
    def get_max_int_width(self, t_index=0):
        '''
    ...
    def get_finger_len(self, t_index=0):
        '''
    ...
    def get_finger_height(self, t_index=0):
        '''
    ...
    def get_finger_orient(self, t_index=0):
        '''
    ...
    def get_fingertip_offset(self, t_index=0):
        '''
...
if __name__ == "__main__":
    ...
    or_dev.report_robot()
    twofg = TWOFG(or_dev)
    print("Connection check: ", twofg.isconn())
